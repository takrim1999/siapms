    ...
    <div *ngIf="project" class="max-w-4xl mx-auto">
      ...
      <div class="flex justify-between items-start mb-8">
        ...
        <div *ngIf="isOwner" class="flex space-x-2">
          ...
          <button (click)="deleteProject()" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-md transition-colors duration-200">
            Delete
          </button>
        </div>
      </div>
        ...
        <div class="flex flex-wrap gap-4">
          <a 
            *ngIf="project.githubLink" 
            ...
            target="_blank"
            class="flex items-center space-x-2 bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-md transition-colors duration-200"
          >
          ...
          <a 
            *ngIf="project.liveLink" 
            ...
            target="_blank"
            class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors duration-200"
          >
